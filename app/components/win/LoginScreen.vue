  ...
  <div class="login-screen" role="dialog" aria-modal="true" aria-label="Connexion">
    ...
    <main class="login-box">
      ...
      <div class="password-row">
        ...
        <button type="submit" class="submit-btn" aria-label="Se connecter" @click="login">
      ...
      <div class="login-options">
        <button type="button" aria-label="Retour à l'écran de verrouillage" @click="$emit('back')">← Retour</button>
        <span aria-hidden="true">·</span>
        <button type="button">Options de connexion</button>
      </div>
    </main>
    <div class="bottom-actions">
      <button type="button" class="bottom-btn" aria-label="Réseau">
        <svg fill="white" height="20" viewBox="0 0 24 24" width="20" aria-hidden="true" focusable="false">
          <path
              d="M1 9l2 2c4.97-4.97 13.03-4.97 18 0l2-2C16.93 2.93 7.08 2.93 1 9zm8 8l3 3 3-3c-1.65-1.66-4.34-1.66-6 0zm-4-4l2 2c2.76-2.76 7.24-2.76 10 0l2-2C15.14 9.14 8.87 9.14 5 13z"/>
        </svg>
      </button>
      <button type="button" class="bottom-btn" aria-label="Facilité d'accès">
        <svg fill="white" height="20" viewBox="0 0 24 24" width="20" aria-hidden="true" focusable="false">
          <circle cx="12" cy="4" r="2"/>
          <path d="M15.97 8.03L14 10h-4L8.03 8.03A1 1 0 007 9v5h2v6h6v-6h2V9a1 1 0 00-1.03-0.97z"/>
        </svg>
      </button>
      <button type="button" class="bottom-btn" aria-label="Arrêter l'ordinateur">
        <svg fill="white" height="20" viewBox="0 0 24 24" width="20" aria-hidden="true" focusable="false">
          <path
