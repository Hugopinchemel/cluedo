...
This project is a web-based simulation of a Windows 10/11-like operating system interface built with **Nuxt 4**, **Vue 3
**, and **SCSS**.
...
- **Window Management:** All window operations (opening, closing, focusing, moving) MUST go through the `useWindows`
  composable.
...
- **Nuxt Conventions:** Follow the standard Nuxt 3/4 directory structure. Note that the application source is located in
  the `app/` directory.
